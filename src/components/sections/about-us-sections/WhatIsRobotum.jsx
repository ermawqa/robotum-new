      ...
      <div className="grid gap-12 lg:gap-16 md:grid-cols-2 items-center">
        ...
        <div className="animate-fadeIn">
          ...
          <ul className="grid gap-3 mb-8">
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-text2 text-white/75">Hands-on robotics: humanoids, creative robotics, web & infrastructure.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-text2 text-white/75">HR, finance & legal, community engagement, and weekly workshops.</p>
              </div>
            </li>
            <li className="flex items-start gap-3">
              <span className="mt-1.5 inline-block h-2 w-2 rounded-full bg-[#22D3EE]"/>
              <div>
                <p className="text-text1 font-semibold">Innovation & Entrepreneurship</p>
                <p className="text-text2 text-white/75">Precelerator, RoboWeek events, ROBO SPARK SUMMIT, and our podcast.</p>
              </div>
            </li>
          </ul>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button as={Link} to="/join" variant="secondary">Join us</Button>
          </div>
        </div>
            ...
            <div className="relative w-full rounded-2xl overflow-hidden bg-white/5 border border-white/10 p-6">
              ...
              <div className="relative grid gap-6">
                ...
                <div className="rounded-xl p-5 bg-white/5 border border-white/10">
                  ...
                  <p className="text-text2 text-white/85">Robotics R&D • Community • Entrepreneurship</p>
                </div>
                <div className="rounded-xl p-5 bg-white/5 border border-white/10">
                  <p className="text-sm text-white/70 mb-2">Collaborations</p>
                  <p className="text-text2 text-white/85">TUM chairs, industry partners & venture labs</p>
                </div>
              </div>
            </div>
          )}
